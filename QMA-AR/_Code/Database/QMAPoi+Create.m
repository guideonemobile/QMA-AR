...
- (NSString *)description {
    return [NSString stringWithFormat:@"<%@: %p, %@>", [self class], self, @{@"Label":self.label, @"Color":self.color, @"Image Name":self.image, @"Audio File":self.audio, @"Person Name":self.personName, @"Gallery Items":@([self.gallery count])}];
}
